...
const Designer = () => {
  return (
    <section className="max-w-screen-2xl mx-auto px-4 py-25">
      {/* Section Title */}
      <div className="text-center space-y-4 max-w-2xl mx-auto mb-15">
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 ">
        {/* Card 1 */}
        <div className="bg-bgColor rounded-2xl shadow-md hover:shadow-xl transition duration-300 p-6 text-center">
          <img
            src={Bestsaler1}
            alt="Accessories"
            className="w-full h-120 object-cover rounded-xl mb-5 hover:scale-105 transition-transform duration-300"
          />
